...
namespace LibFormularios
{
    public partial class FrmBusquedaPersonal : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnSeleccionar_Click(object sender, EventArgs e)
        {
            try
            {
                Numero_Documento = dgvPersonal[0, dgvPersonal.CurrentCell.RowIndex].Value.ToString();
                Nombres = dgvPersonal[1, dgvPersonal.CurrentCell.RowIndex].Value.ToString();
                Apellidos = dgvPersonal[2, dgvPersonal.CurrentCell.RowIndex].Value.ToString();
