...
{
    public partial class FrmRptCertificadosXActaEntrega : FrmActa
    {
        public FrmRptCertificadosXActaEntrega()
        {
            InitializeComponent();
        }

        private void FrmRptCertificadosXActaEntrega_Load(object sender, EventArgs e)
        {
        ...
        {
            string CodigoActaEntrega = txtCodigoActaEntrega.Text;
            //-- Generamos la lista de Actas de Entrega
            CMetodos aMetodos = new CMetodos();
            DataTable Resultado = aMetodos.CertificadosXActaEntrega(CodigoActaEntrega);

            // -- Configurar el origen de datos del reporte
            ReportDataSource rds = new ReportDataSource
            {
                Name = "DsReportes_TCD_XActaEntrega",
                Value = Resultado
            };
            ...
            RutaRDLC = RutaRDLC.Substring(0, idx - 1) + @"\LibFormularios\ReportesRDLC\RptCD_XActaEntrega.rdlc";
